...
import com.mohan.first.web.rest.BookResource;
...
public class BookResourceTest {
    ...
    public void setup() {
        ...
        this.restBookMockMvc = MockMvcBuilders.standaloneSetup(bookResource).setMessageConverters(jacksonMessageConverter).build();
    }
