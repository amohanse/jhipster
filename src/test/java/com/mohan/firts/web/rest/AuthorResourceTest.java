...
import com.mohan.first.web.rest.AuthorResource;
...
public class AuthorResourceTest {
    ...
    public void setup() {
        ...
        this.restAuthorMockMvc = MockMvcBuilders.standaloneSetup(authorResource).setMessageConverters(jacksonMessageConverter).build();
    }
